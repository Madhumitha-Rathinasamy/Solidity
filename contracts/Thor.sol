 ...
 * {ERC721Enumerable}.
 */
contract Thor is Context, ERC165, IERC721, IERC721Metadata, Pausable, Ownable {
    ...
    function approve(address to, uint256 tokenId)
        ...
        whenNotPaused
    {
        address owner = Thor.ownerOf(tokenId);
    ...
    function mint(string memory _URI, uint256 _tokenId) external onlyOwner {
    ...
    function _approve(address to, uint256 tokenId) internal virtual {
        ...
        emit Approval(Thor.ownerOf(tokenId), to, tokenId);
    }
